...
namespace Photon.Pun.UtilityScripts
{
	...
	public class PunTurnManager : MonoBehaviourPunCallbacks, IOnEventCallback
    {
        ...
        {
            get { return Mathf.Max(0f, this.TurnDuration + this.WaitDeltaTime - this.ElapsedTimeInTurn); }
        }

        public float WaitSecondsInTurn
        {
            get{return Mathf.Max(0f, 10.0f - this.WaitDeltaTime);}
        }
        ...
        {
            get {return this.WaitSecondsInTurn <= 0f;}
        }
